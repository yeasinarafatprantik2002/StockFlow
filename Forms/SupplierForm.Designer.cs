namespace StockFlow.Forms
{
    partial class SupplierForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            pnlSearch.Width = 350;
            this.txtSearch.TextChanged += async (s, e) => UpdateGrid(await _supplierService.SearchSuppliersAsync(txtSearch.Text));
            ...
            if (_currentUser.Role == "SuperAdmin" || _currentUser.Role == "Admin")
            {
                ...
                btnAdd.Click += (s, e) => { if (new SupplierEntryForm().ShowDialog() == System.Windows.Forms.DialogResult.OK) LoadSuppliers(); };
            ...
            DashboardForm.StyleGrid(this.dgvSuppliers, System.Drawing.Color.FromArgb(44, 62, 80));
